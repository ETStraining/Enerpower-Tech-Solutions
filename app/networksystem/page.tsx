...
const NetworkingServices: React.FC = () => {
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start bg-gray-100 p-6  md:p-10 min-h-screen ">
      <div className="flex flex-col md:flex-row items-start justify-center w-full max-w-screen-lg mx-auto py-10 my-8 md:my-10">
        ...
        <div className="w-full md:w-1/2 pr-0 md:pr-10 mb-8">
          ...
          <p className="text-gray-700 text-base md:text-lg font-semibold mb
          -4">
          ...
          {/* Expertise Section with Background and Padding */}
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end mt-6 md:mt-10 px-2 md:px-4">
          <Image
            src="/networkservice.png" // Ensure the image is in the public folder
            alt="Networking and Installation Services"
            width={400} // Adjusted for responsiveness
            height={550} // Adjusted for responsiveness
